<div class="p-6 rounded-lg mt-3 text-center justify-center flex flex-col bg-white">
    <p class="font-bold text-xl md:text-2xl">Vice Governor</p>
            ...
            <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4">
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex items-center justify-center mt-2">
                        <input class="mr-1" type="radio" name="vice_governor" value="{{$candidateArrayData->student_id}}" onchange="displayViceGovernor()">
                        <p class="vice_governor text-sm md:text-base">{{$candidateArrayData->name}}</p>
                    </div>
